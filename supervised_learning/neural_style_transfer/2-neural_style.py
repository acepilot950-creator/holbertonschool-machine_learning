...
class NST:
    ...
    def __init__(self, style_image, content_image, alpha=1e4, beta=1):
        """Initialize a neural style transfer object."""
        if (
    ...
    def scale_image(image):
        """Resize and rescale an image for neural style transfer."""
        if (
    ...
    def load_model(self):
        """Load the VGG19 model used to calculate neural style costs."""
