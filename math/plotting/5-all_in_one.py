#!/usr/bin/env python3
"""
Module for plotting multiple graphs in one figure.
"""
...
def all_in_one():
    """
    Plots the previous 5 graphs in a single 3x2 grid figure.
    """
    y0 = np.arange(0, 11) ** 3
    ...
    # 3) Log-scale decay plot: x2 vs y2
    ...
    # 4) Two decay curves: y31 and y32
